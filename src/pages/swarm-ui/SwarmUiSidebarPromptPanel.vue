<template>
  <div class="section">
    ...
    <HumanGate
      ...
      @submit="(feedback) => emit('human-resume', feedback)"
    />
...
import CrossProjectStats from "@/entities/observability/CrossProjectStats.vue";
...
const emit = defineEmits<{
  ...
  (e: "start-run"): void;
  (e: "stop-run"): void;
  (e: "human-resume", feedback: string): void;
