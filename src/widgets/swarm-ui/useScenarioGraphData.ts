/**
 * useScenarioGraphData — derived state for the pipeline graph (gates, tools,
 * warnings, workspace_write override) plus the scenario preview title.
 *
 * Extracted from `SwarmUiPage`; behaviourally identical.
 */
